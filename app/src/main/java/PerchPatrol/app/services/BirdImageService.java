...
public class BirdImageService {
    ...
    public BirdImage getImage(String name) {
        ...
        try {
            FlickrPhotos photos = objectMapper.readValue(new URL("https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key="+this.apiKeyFlickr+"&text="+newName+"&license=2%2C3%2C4%2C5%2C6%2C7%2C8%2C9%2C10&privacy_filter=1&safe_search=1&content_type=1&format=json&nojsoncallback=1"),FlickrPhotos.class);
